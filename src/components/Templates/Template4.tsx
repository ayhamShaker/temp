...
const Template4 = () => {
  return (
    <main className="font-serif hyphens-manual">
      {/* <!-- Page --------------------------------------------------------------------------------------------------------> */}
          ...
          <section className="break-inside-avoid">
            ...
            <section className="mb-2 break-inside-avoid">
              <p className="mt-2 leading-normal text-gray-700 text-md">
                Experienced full-stack web developer with a strong track record
                of independently addressing complex business requirements and
            ...
            <section className="mb-2 border-b-2 border-gray-300 break-inside-avoid">
              ...
              <ul className="pl-3 mt-2 font-normal text-gray-700 text-md leading-snugish">
                <li>
                  ...
                  including HTML, CSS, JavaScript, PHP, and Python, to fulfill
                ...
                <li>
                  ...
                  such as Node.js and Express, to deliver robust and scalable
                  web solutions.
                </li>
                <li>
                  <span className="text-gray-500 transform -translate-y-px select-none">
            ...
            <section className="mb-2 border-b-2 border-gray-300 break-inside-avoid">
              ...
              <ul className="pl-3 mt-2 font-normal text-gray-700 text-md leading-snugish">
                <li>
                  ...
                  engagement, and sales techniques, ensuring a top-notch
            ...
            <section className="mb-2 border-b-0 border-gray-300 break-inside-avoid">
              ...
              <ul className="pl-3 mt-2 font-normal text-gray-700 text-md leading-snugish">
                <li>
                  ...
                  business executive, managing schedules, travel arrangements,
